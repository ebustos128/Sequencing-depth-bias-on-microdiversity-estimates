setwd("/home/ebustos/Escritorio/01.PATOS.experiments/11.Sequencing.bias/05.PARA.ISME/06.Merged/")
...
#Coverage threshold, users can change this value by a desired threshold e.g. 10X or 200X
depth_limit <- 5
...
for (j in gsp) {
  ...
  # Estimation of Average Estimated Error (%) and Standard Error
  ...
  # Average Estimated Error (%) and Standard Error plot at coverage >=5X
